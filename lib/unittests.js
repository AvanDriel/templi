...
module.exports.createUnitTests = async function() {
  ...
  if(testName['test-name']) {
    console.log(
      chalk.green(`You can now use 'npm run ${testName['test-name']}' to run your unit tests!`)
    )
  } else {
    console.log(
      chalk.green(`To run your unit tests, you need to add a script to your package.json which executes '${scriptcommand}'`)
    )
  }
